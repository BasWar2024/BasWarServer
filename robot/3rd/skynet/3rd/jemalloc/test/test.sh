...
for t in $@; do
  ...
  if [ -e "${t}.sh" ] ; then
    ...
    . ${t}.sh && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /home/linguangliang/ggApp/loginserver/src/gg/skynet/3rd/jemalloc/ /home/linguangliang/ggApp/loginserver/src/gg/skynet/3rd/jemalloc/
  else
    export MALLOC_CONF= && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /home/linguangliang/ggApp/loginserver/src/gg/skynet/3rd/jemalloc/ /home/linguangliang/ggApp/loginserver/src/gg/skynet/3rd/jemalloc/
