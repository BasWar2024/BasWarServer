---""
--@module api.config.getMatchCfg
--@author sw
--@release 2022/6/16 19:30:00
--@usage
--api:      /api/config/getMatchCfg
--protocol: http/https
--method:   post
--params:
...
--  }
--example:
--  curl -v 'http://127.0.0.1:4241/api/config/getMatchCfg' -d '{"key":"MatchConfig"}'
...
function handler.exec(linkobj,header,args)
    ...
    local data = gg.dynamicCfg:get("MatchConfig")
