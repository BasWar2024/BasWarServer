---""
--@module api.game.getGmPlayerList
--@author sw
--@release 2022/3/12 10:30:00
--@usage
--api:      /api/game/getGmPlayerList
--protocol: http/https
--method:   post
--params:
...
--  }
--example:
--  curl -v 'http://127.0.0.1:4241/api/analyzer/getGmPlayerList' -d '{}'
...
function handler.exec(linkobj,header,args)
    ...
    local list = {}
    local docs = gg.mongoProxy.gm_players:find({ gm = {["$gte"] = 50}})
