---""
--@module api.game.banChat
--@author sw
--@release 2022/3/12 10:30:00
--@usage
--api:      /api/analyzer/banChat
--protocol: http/https
--method:   post
--params:
...
--  }
--example:
--  curl -v 'http://127.0.0.1:4241/api/game/banChat' -d '{ "pid":1000000 }'
...
function handler.exec(linkobj,header,args)
    ...
    gg.playerProxy:send(pid, "banChat", request.banMinutes)
