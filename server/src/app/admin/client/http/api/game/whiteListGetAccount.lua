---""
--@module api.game.whiteListGetAccount
--@author sw
--@release 2022/3/12 10:30:00
--@usage
--api:      /api/game/whiteListGetAccount
--protocol: http/https
--method:   post
--params:
...
--  }
--example:
--  curl -v 'http://127.0.0.1:4241/api/game/whiteListGetAccount' -d '{"adminAccount":"admin","sign":"e10adc3949ba59abbe56e057f20f883e"}'
...
function handler.exec(linkobj,header,args)
    ...
    local result = gg.shareProxy:call("getWhiteListAccount", pageNo, pageSize)
