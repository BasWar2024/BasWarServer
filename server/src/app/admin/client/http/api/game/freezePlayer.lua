---""
--@module api.game.freezePlayer
--@author sw
--@release 2022/3/12 10:30:00
--@usage
--api:      /api/game/freezePlayer
--protocol: http/https
--method:   post
--params:
...
--  }
--example:
--  curl -v 'http://127.0.0.1:4241/api/analyzer/freezePlayer' -d '{ "pid":1000000 }'
...
function handler.exec(linkobj,header,args)
    ...
    gg.playerProxy:send(pid, "freezePlayer")
