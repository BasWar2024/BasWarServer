---""(TOKEN)""
--@module api.analyzer.getChainRechargeTokenList
--@author sw
--@release 2022/3/12 10:30:00
--@usage
--api:      /api/analyzer/getChainRechargeTokenList
--protocol: http/https
--method:   post
--params:
...
--  }
--example:
--  curl -v 'http://127.0.0.1:4241/api/analyzer/getChainRechargeTokenList' -d '{}'
...
function handler.exec(linkobj,header,args)
    ...
    local result = analyzermgr.getChainRechargeTokenList(pageNo, pageSize, condition)
