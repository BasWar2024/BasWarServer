---""
--@module api.analyzer.getValidNewAddUserStatistic
--@author sw
--@release 2022/3/12 10:30:00
--@usage
--api:      /api/analyzer/getValidNewAddUserStatistic
--protocol: http/https
--method:   post
--params:
...
--  }
--example:
--  curl -v 'http://127.0.0.1:4241/api/analyzer/getValidNewAddUserStatistic' -d '{}'
...
function handler.exec(linkobj,header,args)
    ...
    response.data = analyzermgr.getValidNewAddUserStatisticByMonth(platform,year,month,pageNo,pageSize)
    httpc.send_json(linkobj, 200, response)
end
