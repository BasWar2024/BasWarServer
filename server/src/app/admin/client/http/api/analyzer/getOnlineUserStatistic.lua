---""
--@module api.analyzer.getOnlineUserStatistic
--@author sw
--@release 2022/3/12 10:30:00
--@usage
--api:      /api/analyzer/getOnlineUserStatistic
--protocol: http/https
--method:   post
--params:
...
--  }
--example:
--  curl -v 'http://127.0.0.1:4241/api/analyzer/getOnlineUserStatistic' -d '{}'
...
function handler.exec(linkobj,header,args)
    ...
    response.data = analyzermgr.getOnlineUserStatisticByMonth(platform,year,month,pageNo,pageSize)
    httpc.send_json(linkobj, 200, response)
end
