---""
--@module api.analyzer.getStayUserStatistic
--@author sw
--@release 2022/3/12 10:30:00
--@usage
--api:      /api/analyzer/getStayUserStatistic
--protocol: http/https
--method:   post
--params:
...
--  }
--example:
--  curl -v 'http://127.0.0.1:4241/api/analyzer/getStayUserStatistic' -d '{}'
...
function handler.exec(linkobj,header,args)
    ...
    local playerList = analyzermgr.getStayUserStatisticByMonth(platform,year,month,pageNo,pageSize)
