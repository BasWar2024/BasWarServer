---""("")
--@module api.analyzer.getPaymentStatisticByDay
--@author sw
--@release 2022/3/12 10:30:00
--@usage
--api:      /api/analyzer/getPaymentStatisticByDay
--protocol: http/https
--method:   post
--params:
...
--  }
--example:
--  curl -v 'http://127.0.0.1:4241/api/analyzer/getPaymentStatisticByDay' -d '{}'
...
function handler.exec(linkobj,header,args)
    ...
    local list = analyzermgr.getPaymentStatisticByDay(beginDate, endDate, platform, pageNo, pageSize)
