---""
--@module api.analyzer.getLostUserStatistic
--@author sw
--@release 2022/3/12 10:30:00
--@usage
--api:      /api/analyzer/getLostUserStatistic
--protocol: http/https
--method:   post
--params:
...
--  }
--example:
--  curl -v 'http://127.0.0.1:4241/api/analyzer/getLostUserStatistic' -d '{}'
...
function handler.exec(linkobj,header,args)
    ...
    local data = analyzermgr.getLostUserStatisticByMonth(platform,year,month,pageNo,pageSize)
