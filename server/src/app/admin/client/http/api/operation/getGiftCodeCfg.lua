---""
--@module api.operation.getGiftCodeCfg
--@author sw
--@release 2022/3/12 10:30:00
--@usage
--api:      /api/operation/getGiftCodeCfg
--protocol: http/https
--method:   post
--params:
...
--  }
--example:
--  curl -v 'http://127.0.0.1:4241/api/operation/getGiftCodeCfg' -d '{}'
...
function handler.exec(linkobj,header,args)
    ...
    for k,v in pairs(giftCodeCfg) do
        ...
        info.name = v.name
        info.des = v.des
        info.itemCfgId = v.itemCfgId
        info.limit = v.limit
        info.beginDate = v.beginDate
        info.endDate = v.endDate
