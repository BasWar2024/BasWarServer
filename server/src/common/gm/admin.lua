...
function cgm:register_admin()
    self:register("rebindserver",self.rebindserver,self.TAG_NORMAL,"")
    self:register("rebindaccount",self.rebindaccount,self.TAG_NORMAL,"")
    self:register("delrole",self.delrole,self.TAG_NORMAL,"")
    self:register("recover_role",self.recover_role,self.TAG_NORMAL,"")
    self:register("clone",self.clone,self.TAG_NORMAL,"")
    self:register("serialize",self.serialize,self.TAG_NORMAL,"")
    self:register("deserialize",self.deserialize,self.TAG_NORMAL,"")
    self:register("openserver",self.openserver,self.TAG_NORMAL,"/")
end
