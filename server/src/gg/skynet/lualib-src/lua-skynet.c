...
// static int
// _onexit(struct skynet_context * context, void * ud) {
// 	lua_State *L = ud;
// 	lua_pushcfunction(L, traceback);
// 	int trace = lua_gettop(L);
// 	lua_rawgetp(L, LUA_REGISTRYINDEX, _onexit);
// 	int r = lua_pcall(L, 0, 0 , trace);
// 	if (r != LUA_OK) {
// 		const char * err = lua_tostring(L,-1);
// 		skynet_error(context, "onexit err: %s ", err);
// 	}
// 	lua_settop(L,trace-1);
// 	return 0;
// }
//
//
...
// 	luaL_checktype(L,1,LUA_TFUNCTION);
// 	lua_settop(L,1);
// 	lua_rawsetp(L, LUA_REGISTRYINDEX, _onexit);
// 	skynet_onexit(context,_onexit);
// 	return 0;
// }
