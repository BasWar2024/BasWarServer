...
typedef int (*skynet_cb_onexit)(struct skynet_context * context, void *ud);
void skynet_onexit(struct skynet_context * context, skynet_cb_onexit onexit);
int skynet_handle_exit(struct skynet_context * context, uint32_t handle);
